...
class PDF extends FPDF
{
    ...
    function Header()
    {
        ...
        $this->Cell(0, 15, "Reporte General de Comidas de Mexico", 0, 1, 'C');
        $this->Ln(20);
    }
    function Footer()
    {
    ...
    function TableTitle()
    {
        ...
        $this->Cell(0, 10, "Lista de Comidas", 0, 1, 'C');
        $this->Ln(5);
    }
...
// Cabecera
$header = array($pdf->convertxt("No."), $pdf->convertxt("Nombre"), $pdf->convertxt("Tipo"),
$pdf->convertxt("Precio"), $pdf->convertxt("Region"), $pdf->convertxt("Calorias"), $pdf->convertxt("Estado"),
$pdf->convertxt("Descripción"), $pdf->convertxt("Popularidad"), $pdf->convertxt("Comentarios"));
